...
write_csv(Adjusted_Data,
          "~/Data/Fee_Data_2022/results/MF_Fee_Report_20220826_ag.csv")
...
write_csv(Active_Fees,
          "~/Data/Fee_Data_2022/results/active/fees_activefunds_firm.csv")
...
write_csv(Active_Summary,
          "~/Data/Fee_Data_2022/results/active/fees_activefunds_summary.csv")
...
write_csv(Active_Cat,
          "~/Data/Fee_Data_2022/results/active/cat_activefunds_firm.csv")
...
write_csv(Active_Cat_Pct,
          "~/Data/Fee_Data_2022/results/active/cat_activefunds_highlow.csv")
...
write_csv(Active_MSCat,
          "~/Data/Fee_Data_2022/results/active/MScat_activefunds.csv")
...
write_csv(Active_MSCat_Pct,
          "~/Data/Fee_Data_2022/results/active/MScat_activefunds_highlow.csv")
...
write_csv(
  ...
  "~/Data/Fee_Data_2022/results/active/shareclass_changes_activefunds.csv"
  )
```
...
Passive_Summary <- PassiveFunds %>% 
  ...
  summarise(
    ...
    Sum_Assets_2020 = sum(Net_Asst_2020_AVG, na.rm = TRUE),
    Fee_Wted_2020 = Sum_Assts_Wted_2020 / Sum_Assets_2020,
    Sum_Assts_Wted_2021 = sum(Asst_By_Fee_2020, na.rm = TRUE),
    Sum_Assets_2021 = sum(Net_Asst_2021_AVG, na.rm = TRUE),
    Fee_Wted_2021 = Sum_Assts_Wted_2021 / Sum_Assets_2021
  ) %>%
  select(
...
write_csv(Passive_Summary,
          "~/Data/Fee_Data_2022/results/passive/fees_activefunds_summary.csv")
...
write_csv(
  Passive_Fees_Past,
  "~/Data/Fee_Data_2022/results/passive/past_fees_passivefunds_firm.csv"
)
...
Passive_LowFees_Past %>%
  ...
  write_csv("~/Data/Fee_Data_2022/results/passive/past_lowfees_passivefunds_firm.csv")
```
...
Passive_Cat_Pct <- Passive_Cat %>%
  ...
  write_csv(Passive_Cat_Pct, "~/Data/Fee_Data_2022/results/passive/passivefunds_firm_category.csv")
...
write_csv(Passive_MSCat,
          "~/Data/Fee_Data_2022/results/passive/MScat_passivefunds.csv")
...
write_csv(Passive_MSCat_Pct,
          "~/Data/Fee_Data_2022/results/passive/MScat_passivefunds_highlow.csv")
...
write_csv(
  ...
  "~/Data/Fee_Data_2022/results/passive/shareclass_changes_passivefunds.csv"
  )
...
write_csv(Category,
          "~/Data/Fee_Data_2022/results/shareclass_cuts_total.csv")
